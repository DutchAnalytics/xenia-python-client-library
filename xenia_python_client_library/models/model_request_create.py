...
class ModelRequestCreate(object):
    ...
    @property
    def data(self):
        """Gets the data of this ModelRequestCreate.  # noqa: E501


        :return: The data of this ModelRequestCreate.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this ModelRequestCreate.


        :param data: The data of this ModelRequestCreate.  # noqa: E501
        :type: dict(str, str)
        """
