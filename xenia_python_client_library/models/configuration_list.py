...
class ConfigurationList(object):
    ...
    @property
    def config(self):
        """Gets the config of this ConfigurationList.  # noqa: E501


        :return: The config of this ConfigurationList.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._config
    ...
    def config(self, config):
        """Sets the config of this ConfigurationList.


        :param config: The config of this ConfigurationList.  # noqa: E501
        :type: dict(str, str)
        """
