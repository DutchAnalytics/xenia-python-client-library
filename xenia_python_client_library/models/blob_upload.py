...
class BlobUpload(object):
    ...
    def __init__(self, file=None, local_vars_configuration=None):  # noqa: E501
        """BlobUpload - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def file(self):
        """Gets the file of this BlobUpload.  # noqa: E501


        :return: The file of this BlobUpload.  # noqa: E501
        :rtype: str
        """
        return self._file
    ...
    @file.setter
    def file(self, file):
        """Sets the file of this BlobUpload.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BlobUpload):
            return False
