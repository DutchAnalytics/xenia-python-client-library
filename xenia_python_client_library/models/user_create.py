...
class UserCreate(object):
    ...
    def __init__(self, email=None, password=None, name=None, surname=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def surname(self):
        """Gets the surname of this UserCreate.  # noqa: E501


        :return: The surname of this UserCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def surname(self, surname):
        """Sets the surname of this UserCreate.


        :param surname: The surname of this UserCreate.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                surname is not None and len(surname) > 30):
            raise ValueError("Invalid value for `surname`, length must be less than or equal to `30`")  # noqa: E501
