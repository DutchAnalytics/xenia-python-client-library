...
class PermissionList(object):
    ...
    @property
    def name(self):
        """Gets the name of this PermissionList.  # noqa: E501


        :return: The name of this PermissionList.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PermissionList.


        :param name: The name of this PermissionList.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PermissionList):
            return False
