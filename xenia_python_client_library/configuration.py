...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of xenia_python_client_library.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = xenia_python_client_library.Configuration(
    ...
    Note you can use the constants defined in the xenia_python_client_library.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = xenia_python_client_library.Configuration(
        signing_info = xenia_python_client_library.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://api.dutchanalytics.net/v2.1",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("xenia_python_client_library")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://api.dutchanalytics.net/v2.1",
